...
def parse_media_clause_prop(property: Token, value: Token) -> MediaClause:
    ...
    if value.unit == "px":
        match property.value:
            ...
            case "max-width":
                return DimensionRule(value.value, Dimension.Width, le)
            case "width":
                return DimensionRule(value.value, Dimension.Width, eq)
            case "min-height":
                return DimensionRule(value.value, Dimension.Height, ge)
            case "max-height":
                return DimensionRule(value.value, Dimension.Height, le)
            case "height":
                return DimensionRule(value.value, Dimension.Height, eq)
