...
def test_delete():
    ...
    delete_back_space = Delete(3, Delete.What.Content, Delete.Direction.backward, before="abc")
    ...
    delete_word_backword = Delete(3, Delete.What.Word, Delete.Direction.backward, before = "abc")
